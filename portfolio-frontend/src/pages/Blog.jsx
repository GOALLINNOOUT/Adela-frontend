...
function Blog() {
  ...
  return (
    <Container maxWidth="lg">      <Box my={4} sx={{ bgcolor: mode === 'dark' ? 'background.default' : 'inherit' }}>
        <SectionHeading 
          title="Blog" 
        ...
        />
          ...
          <>           
            <Box mb={4} display="flex" flexWrap="wrap" gap={2} alignItems="center">
              ...
              </FormControl>              <FormControl size="small" sx={{ minWidth: 150 }}>
        ...
        {/* Blog Posts Grid */}        <Grid container spacing={3}>
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Box display="flex" alignItems="center" gap={1}>
                    ...
                    <Typography variant="caption" color="text.secondary">
                      {post.readTime}
                    </Typography>                    <Typography variant="caption" color="text.secondary" sx={{ ml: 'auto' }}>
                      {new Date(post.createdAt).toLocaleDateString()}
                    </Typography>
                  </Box>
                </CardContent>                <CardActions sx={{ p: 2 }}>
                  <Button 
                    size="small" 
